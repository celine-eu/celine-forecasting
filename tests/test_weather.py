...
from celine.meter_forecasting.schema import WEATHER_CONTRACT
from celine.meter_forecasting.weather import (
...
def test_download_splits_archive_and_forecast(monkeypatch):
    ...
    from celine.meter_forecasting import weather as weather_mod
...
def test_features_flow_through_cleaning_prepare_weather():
    ...
    from celine.meter_forecasting.cleaning import prepare_weather
