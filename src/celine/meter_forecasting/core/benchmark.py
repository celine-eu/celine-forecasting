...
leakage-free :func:`~celine.meter_forecasting.core.evaluation.run_backtest`;
the naive candidate reuses the same
:func:`~celine.meter_forecasting.core.evaluation.backtest_origins` timestamps
and calls :func:`~celine.meter_forecasting.core.baselines.naive_forecast`
...
class BenchmarkCandidate:
    ...
    Attributes:
        ...
        model: Backend name resolved via
            :func:`~celine.meter_forecasting.core.forecaster.get_forecaster`,
        ...
        model_config: Optional per-candidate config override. Keys must name a
            :class:`~celine.meter_forecasting.core.config.ForecastConfig`
...
class BenchmarkSuite:
    ...
    :func:`~celine.meter_forecasting.core.evaluation.run_backtest`; the
    seasonal-naive baseline (168h lag) is always evaluated too, using the same
    :func:`~celine.meter_forecasting.core.evaluation.backtest_origins`
