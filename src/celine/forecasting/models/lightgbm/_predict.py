...
def generate_forecast(
    ...
    *,
    ...
    for band_name, band_horizons in config.horizon_bands.items():
        ...
        q25_features = models["q25"].feature_name()
        q75_features = models["q75"].feature_name()
        X_q25 = X_band[q25_features] if q25_features != model_features else X_band
        X_q75 = X_band[q75_features] if q75_features != model_features else X_band
